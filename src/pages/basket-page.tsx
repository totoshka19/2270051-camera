                  ...
                  <li className="basket-item">
                    <div className="basket-item__img">
                      <picture>
                        ...
                        <img src="img/content/orlenok.jpg" srcSet="img/content/orlenok@2x.jpg 2x" width="140"
                          height="120" alt="Фотоаппарат «Орлёнок»"
                        />
                      </picture>
                    </div>
                  ...
                  <li className="basket-item">
                    <div className="basket-item__img">
                      <picture>
                        ...
                        <img src="img/content/das-auge.jpg" srcSet="img/content/das-auge@2x.jpg 2x" width="140"
                          height="120" alt="Ретрокамера «Das Auge IV»"
                        />
                      </picture>
                    </div>
                    <div className="basket-item__description">
